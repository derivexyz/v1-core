...
async function main() {
  ...
  // const deploymentParams = { network, deployer, mockSnx: true, realPricing: true };
  const deploymentParams = { network, deployer, deploymentType: DeploymentType.MockGmxRealPricing };
